...
import { Box1, DocumentText, TickCircle } from "iconsax-react";
var ps;
      ...
      <Container fluid>
        ...
        {logo ? (
          ...
          <button style={{ border: "none", backgroundColor: "transparent" }}>
            <Box1 className="logoicon mt-6" color="#555555" size="16" variant="Bulk"
              onClick={() => history.push(`/admin/orderStatus`)} />
          </button>
